...
public class ContaGUI extends JFrame {
    ...
    private void criarInterface() {
        ...
        painelMenu =
                new PainelMenuLateral();

        painelMenu.setPreferredSize(
                new Dimension(
                        220,
                        0
                )
        ...
        painelContaSelecionada =
                new PainelContaSelecionada();
    ...
    private void carregarDados() {
        ...
        painelResumo.atualizar(
                painelContas.getContasExibidas(),
                contaService
        );
    }
